    ...
    <div ref={root} className="premium-site">
      ...
      <footer className="site-footer">
        <div className="section-shell footer-main">
          <div className="footer-brand"><a href="#top" className="brand"><span className="brand-mark"><Icon name="layers" size={20} /></span><span>TaskFlow</span></a><p>Projects, people, and progress in one calm workspace.</p></div>
